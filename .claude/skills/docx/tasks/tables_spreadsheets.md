...
```bash
python scripts/xlsx_to_docx_table.py /tmp/input.xlsx /tmp/table.docx --title "Table: Results"
```
...
```bash
python scripts/docx_table_to_csv.py /tmp/input.docx --table_index 0 --out /tmp/table0.csv
```
